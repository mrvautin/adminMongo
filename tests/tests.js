...
describe('test mongo uri parser', function (){
    it('parse default connect string', function (done){
        let mongoUri = require('../routes/mongouri');
        let connect_string = 'mongodb://user:password@host:1234/db?option1=1&option2=2';
        let uriObject = mongoUri.parse(connect_string);
        assert(uriObject.scheme === 'mongodb://');
    ...
    it('parse replicaset connect string', function (done){
        let mongoUri = require('../routes/mongouri');
        let connect_string = 'mongodb+srv://user:password@host/db?option1=1&option2=2';
        let uriObject = mongoUri.parse(connect_string);
