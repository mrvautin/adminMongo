...
var toCleanDir = path.join(currentDir, './../admin-mongo/'); // Delete all children and the parent
...
// TODO: Check if <root> dir has node_modules, if no - don't start postinstall script
// Copy
